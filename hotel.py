...
#             print("\t\t\t 1 الحجز\n")
#             print("\t\t\t 2 معلومات الغرف\n")
#             print("\t\t\t 3 خدمة الغرف (باقات القائمة)\n")
#             print("\t\t\t 4 تقسيط\n")
#             print("\t\t\t 5 تسجيل\n")
#             print("\t\t\t 0 خروج\n")
...
def Booking():
                ...
                # type and it's price
                if ch==0:
                    print(" 1. Standard Non-AC - Yer. 3500")
                    print(" 2. Standard AC - Yer. 4000")
                    print(" 3. 3-Bed Non-AC - Yer. 4500")
                    print(" 4. 3-Bed AC - Yer. 5000")
                    ch=int(input("->"))
                if ch==1:
